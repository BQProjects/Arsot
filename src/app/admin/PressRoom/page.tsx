...
const PressRoomAdminScreen = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    bannerUrl: "",
    sections: [] as PressReleaseSection[],
  });
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [isEditing, setIsEditing] = useState(false);
  const [editingPressRelease, setEditingPressRelease] =
  ...
  const uploadToCloudinary = async (file: File) => {
    ...
    formData.append("upload_preset", "press-releases");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        isEditing
          ? `/api/press-releases/${editingPressRelease!._id}`
          : "/api/press-releases",
        {
      ...
      if (response.ok) {
        ...
        const errorData = await response.json().catch(() => ({}));
        alert(
          `Failed to ${isEditing ? "update" : "save"} press release: ${
  ...
  const handleView = (pressRelease: PressRelease) => {
  ...
  return (
    <div className="relative">
          ...
          <div className="max-w-7xl mx-auto">
            {isModalOpen && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-black p-6 rounded-lg max-w-7xl w-full max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="flex justify-center items-center py-16 px-4 mx-auto">
                      <div className="text-center">
                        ...
                        <div className="text-white/40 font-['Montserrat'] text-sm">
                          Create your first press release using the form above
                        </div>
                      </div>
                    </div>
                  ) : (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 p-2">
                          ...
                          >
                            ...
                            >
                              <path
                                d="M8.5 4C6.84315 4 5.5 5.34315 5.5 7C5.5 8.65685 6.84315 10 8.5 10C10.1569 10 11.5 8.65685 11.5 7C11.5 5.34315 10.1569 4 8.5 4ZM8.5 8.5C7.67157 8.5 7 7.82843 7 7C7 6.17157 7.67157 5.5 8.5 5.5C9.32843 5.5 10 6.17157 10 7C10 7.82843 9.32843 8.5 8.5 8.5Z"
                                fill="#8C8C8C"
                              />
                              <path
                                d="M8.5 1C4.63401 1 1.5 4.13401 1.5 8C1.5 11.866 4.63401 15 8.5 15C12.366 15 15.5 11.866 15.5 8C15.5 4.13401 12.366 1 8.5 1ZM8.5 13.5C5.46243 13.5 3 11.0376 3 8C3 4.96243 5.46243 2.5 8.5 2.5C11.5376 2.5 14 4.96243 14 8C14 11.0376 11.5376 13.5 8.5 13.5Z"
                                fill="#8C8C8C"
                              />
                            </svg>
                          </button> */}
      ...
      {/* Modal for viewing press release */}
      {showModal && selectedPressRelease && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-black border border-neutral-700 rounded-lg max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-white font-['PlayfairDisplay'] text-2xl">
              ...
              {selectedPressRelease.banner && (
                <div className="mb-6">
                  <Image
                    src={selectedPressRelease.banner}
                    width={800}
                    height={400}
              ...
              <div className="text-white/80 font-['Montserrat'] text-sm mb-6">
                Date: {new Date(selectedPressRelease.date).toLocaleDateString()}
              </div>

              <div className="space-y-6">
                {selectedPressRelease.sections.map((section, index) => (
                  <div key={index}>
                    {section.type === "heading" && (
                      <h4 className="text-white font-['PlayfairDisplay'] text-xl mb-2">
                        {section.content}
                      </h4>
                    )}
                    ...
                    {section.type === "quote" && (
                      <blockquote className="text-white/80 font-['Montserrat'] italic border-l-4 border-orange-500 pl-4">
...
export default PressRoomAdminScreen;
