      ...
      <div className="flex justify-between items-start pl-8 pr-8">
        ...
        <div className="flex flex-col max-w-[46rem]">
          ...
          <div className="w-full text-neutral-100/[.80] font-['Montserrat'] text-sm leading-[150%] mb-8">
            With years of expertise in corporate aviation, ARSOT ensures
            seamless operations across Latin America. From permits and fueling
            to VIP handling and on-ground support, our 24/7 team delivers
            precision, care, and reliability—making every journey stress-free.
          </div>
